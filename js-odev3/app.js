...
//find category in array menu and create button each object
...
categoryList.forEach((btn) => {
  ...
  button.classList.add("btn", "btn-item", "btn-outline-dark");
  btnContainerDOM.appendChild(button);
...
//                    <h4>$ 10.99</h4>
//                  </div>
//                  <div class="menu-text">Spicy rice cakes, serving with fish cake.
//                  </div>
//                </div>
//              </div>
...
function getButtons(){
  const result=(this.getAttribute("id")=="All")? menu:
  menu.filter((item) => {
